        ...
        <ThemedView style={styles.content}>
          ...
          <ThemedView style={styles.section}>
            ...
            <ThemedText style={styles.paragraph}>
              ...
              mechanisms provided by your operating system. We do not have
              access to this data, and it is not transmitted to any external
          ...
          <ThemedView style={styles.section}>
            ...
            <ThemedText style={styles.paragraph}>
              Pancake Theory does not use any third-party analytics,
              advertising, or tracking services. We do not share your
